...
class UsuariosRoutes {
    ...
    config(): void {
        ...
        this.router.put('/update/:idusuario', usuarioController.actualizar_usuario);//actualizar un usuario
        this.router.delete('/delete/:idusuario', usuarioController.eliminar_usuario);//eliminar a un usuario
